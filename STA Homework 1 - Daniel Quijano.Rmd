...
```{r}
par(mfrow = c(2,2))
hist(nongreen$age, main = 'Age of nongreen Buildings', xlab = 'age', xlim = range(1:150), breaks = 20, ylim = range(1:2000))
hist(green_only$age, main = 'Age of GREEN Buildings', xlab = 'age', xlim = range(1:150), breaks = 10, ylim = range(1:2000))

barplot(table(nongreen$class_a==0, nongreen$class_a==1), main = 'Fancy nongreen Buildings', ylim = range(1:4500))
barplot(table(green_only$class_a==0, green_only$class_a==1), main = 'Fancy GREEN Buildings', ylim = range(1:4500))
```
